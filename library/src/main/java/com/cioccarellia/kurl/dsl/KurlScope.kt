...
/**
 * Represents the Execution Scope of a [Kurl launcher function][KurlLauncher].
 * It is the base class for the inline DSL of Kurl.
 * */
data class KurlScope @PublishedApi internal constructor(
    ...
    /**
     * Returns the [request builder][KurlRequestBuilder] generated by the
     * surrounding [kurl scope][KurlScope].
     * */
    fun get() = KurlRequestBuilder(api, endpoint, urlParameters, headers, fragment)
